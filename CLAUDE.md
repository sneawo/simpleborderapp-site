...
Marketing site for the **Simple Border** iOS/macOS/Android app (App Store id `6451375021`, Google Play id `com.sneawo.simpleborder`), served as a static site at https://simpleborder.app via GitHub Pages (see `CNAME`). There is no app source code here — only the public website.
...
- **Pages currently shipped:** `index.html`, `changelog.html`, `changelog-android.html`, `how-to-add-borders-to-photos-on-iphone.html`, `how-to-format-images-for-instagram-without-cropping.html`, `how-to-prepare-instagram-carousel-photos-on-iphone.html`. Font Awesome is loaded from a CDN.
